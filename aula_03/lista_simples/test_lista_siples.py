...
from aula_03.lista_simples.lista_simples import ListaLigadaSimples
from aula_03.lista_simples.noh import Noh
from aula_03.orientacao_a_objetos import Carro

# no pycharm o coamndo alt+enter com o curso depois do nome da classe
# o pycharm cria uma nova classe caso ela não exista


class TesteNoh(unittest.TestCase):
    def test_criacao_de_noh_com_multiplos_objetos(self):
        for objeto in (1, 'Renzo', Carro('Chevete')):
            # neste caso o with vai fazer passar um objecto de cada vez para não falhar todos os testes
