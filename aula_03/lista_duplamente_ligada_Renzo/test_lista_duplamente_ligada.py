import unittest
from aula_03.lista_duplamente_ligada_Renzo.lista_duplamente_ligada import ListaDuplamenteLigada
from aula_03.lista_duplamente_ligada_Renzo.lista_duplamente_ligada import Noh
...
class NohTestes(unittest.TestCase):
    ...
    def test_init_com_no_direito(self):
        ...
        self.assertEquals(direito, noh.direito)
        self.assertIsNone(noh.esquerdo)
